...
with open('/home/lbcb/magre/arquivos/modelos/modelo_random_forest.pkl', 'rb') as arquivo:
...
def preprocess_data(amino_seq):
    ...
    dados_csv = pd.read_csv('/home/lbcb/magre/arquivos/saida/tabelaDescritoresNew_28-07-2024.csv', sep=';')
